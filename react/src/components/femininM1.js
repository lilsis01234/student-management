...
class FemininM1 extends React.Component{
    state={etudiant:[]}
   ...
   render(){
    return(
        ...
        <div className="jumbotron jumbotron-fluid text-success">Nombre de filles en M1: {this.state.etudiant.length}</div>     
