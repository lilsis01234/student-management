...
class MasculinL3 extends React.Component{
    state={etudiant:[]}

    componentDidMount(){
        axios.get("http://127.0.0.1:8000/api/masculinL3")
        .then(
   ...
   render(){
    return(
        ...
        <div className="jumbotron jumbotron-fluid text-success">Nombre de garçons en L3: {this.state.etudiant.length}</div>     
