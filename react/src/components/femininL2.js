...
class FemininL2 extends React.Component{
    state={etudiant:[]}

    componentDidMount(){
        axios.get("http://127.0.0.1:8000/api/femininL2")
        .then(
   ...
   render(){
    return(
        ...
        <div className="jumbotron jumbotron-fluid text-success">Nombre de filles en L2: {this.state.etudiant.length}</div>     
