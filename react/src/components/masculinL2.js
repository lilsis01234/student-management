...
class MasculinL2 extends React.Component{
    state={etudiant:[]}
   ...
   render(){
    return(
        ...
        <div className="jumbotron jumbotron-fluid text-success">Nombre de garçons en L2: {this.state.etudiant.length}</div>     
