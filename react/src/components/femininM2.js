...
class FemininM2 extends React.Component{
    state={etudiant:[]}
   ...
   render(){
    return(
        ...
        <div className="jumbotron jumbotron-fluid text-success">Nombre de filles en M2: {this.state.etudiant.length}</div>     
